...
CORE_BANKING = {
    ...
    QQQ: {
        'lines': [
            ...
            ('2023-10-26', 10, 250, '2023-07-18', '2024-07-10'),
    ...
    KWEB: {
        'lines': [
            ('2024-10-07', '2025-01-30', 5, 60),
            ('2024-11-22', 10, 100, '2024-10-07', '2025-01-30'),
        ],
        'elliott': {
            '2023-01-26': ['((1))'],
            '2023-03-09': ['a'],
    ...
    NVDA: {
        'lines': [
            ('2023-07-18', '2024-06-18', 10, 10),
            ('2024-01-03', 10, 200, '2023-07-18', '2024-06-18'),
        ],
        'elliott': {
            '2023-07-18': ['(1)'],
            '2023-10-26': ['(2)'],
    ...
    META: {
        'lines': [
            ('2024-04-05', '2025-02-14', 10, 40),
            ('2024-04-30', 10, 250, '2024-04-05', '2025-02-14'),
        ],
        'elliott': {
            '2023-07-28': ['(1)'],
            '2023-10-26': ['(2)'],
    ...
    NFLX: {
        'lines': [
            ('2023-10-18', '2024-08-05', 10, 10),
            ('2023-07-19', 10, 370, '2023-10-18', '2024-08-05'),
        ],
        'elliott': {
            '2023-07-19': ['(1)'],
            '2023-10-18': ['(2)'],
    ...
    AMZN: {
        'lines': [
            ...
            ('2024-07-02', 10, 200, '2023-10-26', '2024-08-05'),
        ],
        'elliott': {
            '2023-10-26': ['(2)'],
            '2024-07-02': ['(3)'],
    ...
    JPM: {
        'lines': [
            ('2024-08-30', '2024-11-25', 10, 100),
            ('2024-09-13', 10, 90, '2024-08-30', '2024-11-25'),
        ],
        'elliott': {
            '2024-08-30': ['1'],
            '2024-09-13': ['2'],
    ...
    NVO: {
        'lines': [
            ...
            ('2024-08-30', 10, 100, '2024-08-07', '2024-12-20'),
        ],
        'elliott': {
            '2023-04-21': ['(1)'],
            '2023-07-11': ['(2)'],
    ...
    AVGO: {
        'lines': [
            ('2023-09-21', '2024-08-07', 10, 10),
            ('2024-06-17', 10, 200, '2023-09-21', '2024-08-07'),

            ('2024-11-27', '2025-01-27', 10, 40),
            ('2024-12-16', 10, 100, '2024-11-27', '2025-01-27'),
        ],
        'elliott': {
            '2023-08-01': ['(1)'],
            '2023-09-21': ['(2)'],
    ...
    BAC: {
        'lines': [
            ('2024-01-18', '2024-04-16', 10, 10),
            ('2024-03-28', 10, 100, '2024-01-18', '2024-04-16'),

            ('2024-09-13', '2024-12-19', 10, 100),
        ],
        'elliott': {
            '2023-12-14': ['1'],
            '2024-01-18': ['2'],
