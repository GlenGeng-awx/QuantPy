...
CORE_BANKING = {
    IXIC: {
        'lines': [
            ...
            ('2023-03-10', 10, 370, '2023-02-02', '2023-07-19'),
    ...
    SS_000300: {
        'lines': [
            ...
            ('2023-07-24', 5, 270, '2023-04-18', '2023-08-04'),
            ('2023-09-04', '2023-11-06', 5, 70),
            ('2023-08-23', 10, 90, '2023-09-04', '2023-11-06'),
            ('2024-05-20', '2024-07-19', 5, 30),
    ...
    TSLA: {
        'lines': [
            ...
            ('2024-04-22', '2024-08-07', 10, 15),
            ('2024-07-10', '2024-08-21', 10, 5),
        ],
        'sr_levels': [
            ('2023-02-15', 10, 200),
            ('2023-06-20', 10, 200),
    ...
    PLTR: {
        'lines': [
            ('2023-08-01', '2024-03-07', 10, 120),
            ('2023-10-30', 10, 200, '2023-08-01', '2024-03-07'),
        ],
    },
    SNOW: {
        'lines': [
    ...
    NVDA: {
        'lines': [
            ...
            ('2024-04-19', 10, 90, '2024-03-07', '2024-06-18'),
        ],
    },
    BEKE: {
        'lines': [
    ...
    EDU: {
        'lines': [
            ...
            ('2024-04-24', 10, 88, '2024-05-14', '2024-07-03'),
        ],
    },
}
