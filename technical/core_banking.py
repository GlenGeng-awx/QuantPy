...
CORE_BANKING = {
    ...
    FUTU: {
        'lines': [
            ...
            ('2024-05-17', 10, 100, '2023-02-01', '2023-09-06'),
    ...
    MRNA: {
        'lines': [
            ...
            ('2024-01-08', 10, 200, '2023-03-01', '2023-08-15'),
    ...
    XPEV: {
        'lines': [
            ...
            ('2023-07-28', 10, 300, '2023-08-29', '2023-09-29'),
    ...
    LI: {
        'lines': [
            ...
            ('2023-08-07', 5, 300, '2023-10-20', '2024-01-22'),
    ...
    GTLB: {
        'lines': [
            ...
            ('2023-12-28', 10, 200, '2023-02-02', '2023-07-13'),
            ('2023-12-20', 10, 200, '2023-02-02', '2023-07-13'),
        ],
    },
}
