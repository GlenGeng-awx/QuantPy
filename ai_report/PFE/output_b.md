...
本地评分: 2/6 → + 护城河 ✗ → **2/7 = 平庸**
> GM ✓ + FCF yield ✓ + FCF−SBC ✓ = 3 通过; NM ✗ + 缩股 ✗ + ROIC ✗ + 护城河 ✗ = 4 失败
> 修正: 3/7 非好公司 → **3/7 = 好公司**（3-5 区间）
> Wait: GM ✓ + NM ✗ + FCF yield ✓ + FCF−SBC ✓ + 缩股 ✗ + ROIC ✗ + 护城河 ✗ = 3/7 → 好公司

→ **3/7 = 好公司**（NM 低 + 无缩股 + ROIC 低 + 护城河收窄 → 限制不进伟大）
