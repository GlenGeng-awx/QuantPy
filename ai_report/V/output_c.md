...
- **CAGR 列号验证**：Visa income_annual 列0=FY25(2025-09), 列2=FY23(2023-09)=2年前, 列3=FY22(2022-09)=3年前。`forward_g.md` 公式"Rev[2]=3年前"在此偏移 → 用列0/列3 算真 3yr CAGR（避免 mistakes.md #11）
- 近期 vs 3yr: **加速**（3yr CAGR 10.9% → Q3'26 YoY 14.3% + 分析师 FY26 14.4%）。跨境交易复苏 + Visa Direct（世界杯）+ 增值服务驱动。
- 本地 g（10.5-10.9%）< 外部 g（14-15%）→ 增长加速，但 1yr YoY 含短期催化（世界杯/跨境复苏），不可直接外推长期
- PEG 18.9% >> 其他源 → 市场 pricing 高增长，安全边际薄

### G-3 Step 2-4

- Step 2 剔除：#3 EPS CAGR（回购扭曲）、#5 PEG（市场乐观，g 失真风险）
- Step 3 剔除最高：#7 分析师 FY26 EPS +15.2%（1yr 加速，不可持续外推）
- 剩余：{10.93, 10.50, 14.36, 14.4, 10.2, 14.4}
- 均值 = 12.47%

### Step 5 定性调整

均值 12.45% 被 1yr YoY（14%+）拉高。3yr CAGR 10.5-10.9% 是可持续基线（支付量增长 + 现金电子化 + 增值服务），短期加速含世界杯/跨境复苏不可外推。保守偏置取 3yr CAGR 区间下限。
