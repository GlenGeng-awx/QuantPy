...
本地评分: 1/5（仅 FCF−SBC ✓，GM/NM/缩股/ROIC 四项 ✗）+ 护城河中等（不加）= 1/6 = **平庸**

> ⚠ 旧 output_b 误标 ROIC ✓*（实际 7.8% <15%），已修正 → 评分从 2/6 降至 1/6。GAAP 指标被 Xilinx 摊销压低（非 GAAP GM 56%/NM 25% 更高），但框架用 GAAP → 1/6 平庸。BS 强（净现金 $8.48B、利息覆盖 29.5x）但盈利质量指标（GM/NM/ROIC）均不达标。
