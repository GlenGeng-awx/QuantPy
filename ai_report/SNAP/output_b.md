...
| NM >20% | TTM −4.9%（亏损） | ✗ |
| FCF yield >5% | 7.8%（$705M/$9.01B MCap） | ✓ |
| FCF − SBC >0 | −$325M（硬规则触发） | ✗ |
| 真缩股 | 1.61B→1.69B 3yr（膨胀 +5%） | ✗ |
| ROIC/ROE >15% | ROIC −9.2%、ROE −15.6%（全负） | ✗ |

本地评分: **1/6** → 至少 **"平庸 ×0.60"**，FCF−SBC<0 升档为 **重麻烦 ×0.40**（硬规则）。待 C 确认护城河（窄，份额流失中）→ 不升级。

> 按 `discount_coefficient.md`：本地 1/6 + 护城河窄（0）= 1/7 = **平庸**；FCF−SBC<0 自动触发重麻烦档 → **平庸 × 重麻烦 = ×0.40**。
