...
CORE_BANKING = {
    ...
    TSM: {
        'lines': [
            ('2024-07-10', '2025-01-23', 10, 10),
            ('2024-08-05', 10, 160, '2024-07-10', '2025-01-23'),
        ],
        'elliott': {
            '2023-06-14': ['(1)'],
            '2023-09-26': ['(2)'],
    ...
    AAPL: {
        'lines': [
            ...
            ('2024-12-26', '2025-02-24', 10, 60),
            ('2025-01-21', 10, 100, '2024-12-26', '2025-02-24'),
        ],
        'elliott': {
            '2022-11-09': ['S'],
            '2023-01-05': ['H'],
    ...
    MCD: {
        'lines': [
            ('2022-09-30', '2024-07-09', 10, 100),
            ('2024-10-18', 300, 200, '2022-09-30', '2024-07-09'),
            ('2023-06-30', 100, 500, '2022-09-30', '2024-07-09'),
