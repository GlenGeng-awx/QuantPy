...
CORE_BANKING = {
    ...
    META: {
        'lines': [
            ...
            ('2024-07-25', 10, 170, '2023-07-28', '2024-04-05'),
    ...
    SHOP: {
        'lines': [
            ('2024-09-06', '2025-01-14', 30, 40),
            ('2025-02-18', '2025-03-25', 10, 100),
    ...
    MA: {
        'lines': [
            ...
            ('2023-10-27', 100, 400, '2023-01-25', '2024-03-21'),
    ...
    VISA: {
        'lines': [
            ('2022-09-30', '2024-07-24', 5, 200),
            ('2024-03-21', 300, 300, '2022-09-30', '2024-07-24'),
