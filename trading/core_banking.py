...
CORE_BANKING = {
    ...
    QQQ: {
        'lines': [
            ...
            ('2023-10-26', 10, 280, '2023-07-18', '2024-07-10'),
    ...
    NFLX: {
        'lines': [
            ...
            ('2024-10-17', '2025-01-14', 10, 100),
            ('2024-12-11', 10, 100, '2024-10-17', '2025-01-14'),
        ],
        'elliott': {
            '2023-07-19': ['(1)'],
            '2023-10-18': ['(2)'],
    ...
    AMZN: {
        'lines': [
            ...
            ('2024-11-22', '2025-03-18', 20, 100),
            ('2024-11-13', 10, 100, '2024-11-22', '2025-03-18'),
        ],
        'elliott': {
            '2023-10-26': ['(2)'],
            '2024-07-02': ['(3)'],
    ...
    ORCL: {
        'lines': [
            ('2024-11-21', '2025-01-23', 10, 40),
            ('2025-01-13', 10, 100, '2024-11-21', '2025-01-23'),
        ],
        'elliott': {
            '2023-06-15': ['(1)'],
            '2023-12-14': ['(2)'],
    ...
    ADBE: {
        'lines': [
            ...
            ('2024-12-06', '2025-02-18', 10, 10),
            ('2025-01-10', 10, 100, '2024-12-06', '2025-02-18'),
        ],
        'elliott': {
            '2023-03-31': ['(1)'],
            '2023-05-12': ['(2)'],
    ...
    BAC: {
        'lines': [
            ('2024-01-18', '2024-08-05', 10, 100),
            ('2024-07-16', 10, 120, '2024-01-18', '2024-08-05'),

            ('2024-07-16', '2025-02-06', 10, 10),
            ('2024-08-05', 10, 200, '2024-07-16', '2025-02-06'),
        ],
        'elliott': {
            '2023-12-14': ['(1)'],
            '2024-01-18': ['(2)'],
    ...
    HPQ: {
        'lines': [
            ('2024-04-18', '2024-08-07', 10, 10),
            ('2024-01-08', 10, 160, '2024-04-18', '2024-08-07'),

            ('2024-11-25', '2025-02-20', 10, 10),
            ('2024-12-19', 10, 100, '2024-11-25', '2025-02-20'),

            ('2024-09-12', '2024-12-19', 10, 100),
            ('2024-08-30', 10, 140, '2024-09-12', '2024-12-19'),
    ...
    NU: {
        'lines': [
            ('2023-07-13', '2024-03-22', 10, 200),
            ('2023-09-05', 10, 200, '2023-07-13', '2024-03-22'),
    ...
    PYPL: {
        'lines': [
            ('2022-12-28', '2023-05-25', 10, 120),
            ('2023-02-02', 60, 260, '2022-12-28', '2023-05-25'),

            ('2024-07-25', '2025-03-13', 10, 10),
            ('2025-01-17', 100, 100, '2024-07-25', '2025-03-13'),
        ],
        'elliott': {
            '2024-01-19': ['1'],
            '2024-07-25': ['2'],
