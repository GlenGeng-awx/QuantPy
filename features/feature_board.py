...
from features import (f_001_b, f_002_b, f_003_b, f_004_b, f_005_b, f_006_b,
                      f_007_b, f_008_b, f_009_b, f_010_b)
from features import (f_001_s, f_002_s, f_003_s, f_004_s, f_005_s, f_006_s,
                      f_007_s, f_008_s)
...
def display_feature(stock_df: pd.DataFrame, fig: go.Figure):
    for params in [
